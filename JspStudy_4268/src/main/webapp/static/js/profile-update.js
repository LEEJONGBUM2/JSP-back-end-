...
updateSubmitBtn.onclick = () => {
	...
	//1,2 조건이 만족되면 submit()
	/*if(isempty == profileInput[0].value || profileInput[1].value){
		alert("해당 값은 비어 있습니다.");
	}else if(originPrincipal.name != profileInput[0].value && originPrincipal.email != profileInput[1].value){
		alert("해당 값은 포함되어 있습니다.");	
	}*/
