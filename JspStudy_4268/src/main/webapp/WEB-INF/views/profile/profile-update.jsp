...
<meta charset="UTF-8">
<title>마이페이지</title>
<link rel="stylesheet" href="/JspStudy_4268/static/css/style.css">
<link rel="stylesheet" href="/JspStudy_4268/static/css/mypage.css">
</head>
<body>
	<div id="container">
		<div class="mypage-items">
			<form action="/JspStudy_4268/profile/update" method="post">
				<table>
					<tr>
						<td>사용자 이름</td>
	...
	<script type="text/javascript" src="/JspStudy_4268/static/js/profile-update.js"></script>
</body>
</html>